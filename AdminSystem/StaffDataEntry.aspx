...
<body style="height: 20px; width: 409px">
    <form id="form1" runat="server">
        ...
        <asp:Label ID="lblGender" runat="server" style="z-index: 1; left: 17px; top: 222px; position: absolute" Text="Gender" width="41px"></asp:Label>
        ...
        <asp:Button ID="btnReturn" runat="server" OnClick="btnReturn_Click" style="z-index: 1; left: 275px; top: 391px; position: absolute" Text="Return to Main Menu" />
    </form>
</body>
</html>
